...
class Database:
    ...
    def get_user(self, uid: int) -> Any:
        ...
        """
        return self._execute(_queries.get_user, (uid,))

    def get_user_language(self, uid: int) -> Optional[str]:
        ...
        """
        query: str = _queries.get_user_language
        result: Optional[tuple] = self._execute(query, (uid,))
        return result[0] if result else None

    def set_user_language(self, uid: int, language: str) -> Any:
        ...
        """
        self._execute(_queries.set_user_languade, (uid, language))
